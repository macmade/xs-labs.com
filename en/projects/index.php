...
<div class="marketing">
    <div class="row">
        <div class="col-sm-4">
            ...
            <h3><?php print \XS\Menu::getInstance()->getPageLink( '/projects/xeos' ); ?></h3>
            <p>
        ...
        <div class="col-sm-4">
            ...
            <h3><?php print \XS\Menu::getInstance()->getPageLink( '/projects/xsfoundation' ); ?></h3>
            <p>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <h3><?php print \XS\Menu::getInstance()->getPageLink( '/projects/xeos-software-license' ); ?></h3>
            <p>
            ...
            <p>
                <a class="btn btn-default" href="<?php print \XS\Menu::getInstance()->getPageUrl( '/projects/xeos-software-license' ); ?>">Learn more »</a>
            </p>
        </div>
        <div class="col-sm-4">
            <div>
                <a href="<?php print \XS\Menu::getInstance()->getPageUrl( '/projects/coding-style-guide' ); ?>"><img src="/uploads/image/coding-style-guide/icon-circle.png" alt="Coding Style Guide" width="140" height="140" /></a>
            </div>
            <h3><?php print \XS\Menu::getInstance()->getPageLink( '/projects/coding-style-guide' ); ?></h3>
            <p>
                XS-Labs coding style guide for C, C++, Objective-C and x86 assembly.
            </p>
            <p>
                <a class="btn btn-default" href="<?php print \XS\Menu::getInstance()->getPageUrl( '/projects/coding-style-guide' ); ?>">Learn more »</a>
            </p>
        </div>
